...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/supplier-inspection', name: 'supplier-inspection', meta: { title: '供应商 · 考察 · 合格入库/不合格不入' }, component: () => import('@/views/SupplierInspection.vue') },
    ...
    { path: '/asset', name: 'asset', meta: { title: '设备 · 租赁台账' }, component: () => import('@/views/Asset.vue') },
