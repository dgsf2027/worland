...
export const sessionDisplayName = ref(localStorage.getItem('rent_user_name') || '')
export const sessionRole = ref(localStorage.getItem('rent_user_role') || '')
...
export function setSession(token: string, displayName: string, role: string): void {
  ...
  sessionDisplayName.value = displayName
